...
const PLANS = [
  ...
  },
  {
    ...
    features: [
      'Treinos ilimitados',
      'GPS avançado + elevação',
      'Histórico completo',
      'Zonas cardíacas',
      'Planos de 5K a maratona',
      'Suporte prioritário',
    ],
    cta: 'Assinar agora',
    highlight: true,
  },
  {
    ...
    features: [
      'Tudo do Runner',
      'Coach de IA em tempo real',
      'Análise biomecânica',
      'Integração com coach humano',
  ...
  return (
    ...
    >
      ...
      >
        ...
        <span style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: 34, color: '#FF4500' }}>
          X
        </span>
      </div>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 36 }}>
        ...
        <button
          ...
          onMouseEnter={(e) => {
            ...
            e.target.style.boxShadow = '0 8px 32px rgba(255,69,0,0.55)';
          }}
          onMouseLeave={(e) => {
            e.target.style.transform = '';
            e.target.style.boxShadow = '0 4px 24px rgba(255,69,0,0.4)';
          }}
        >
          Entrar
        </button>
  ...
  return (
    <section
      ...
      style={{
        ...
        overflow: 'hidden',
        background:
          'radial-gradient(ellipse 80% 60% at 50% 0%, rgba(255,69,0,0.12) 0%, transparent 65%), #080C18',
      }}
    >
      {/* Animated grid */}
      <div
      ...
      >
        ...
        <div style={{ display: 'flex', alignItems: 'baseline', gap: 4, marginTop: 4 }}>
          <span style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: 28, color: '#F0F4FF' }}>
            42.3
          </span>
          <span style={{ fontFamily: "'Space Mono', monospace", fontSize: 12, color: '#7A869A' }}>
            km
          </span>
        </div>
        <div
      ...
      <div style={{ position: 'relative', zIndex: 1, textAlign: 'center', maxWidth: 820 }}>
        ...
        >
          Treinos personalizados por IA, análise em tempo real e evolução garantida. Do seu primeiro
          5K à maratona dos sonhos.
        </p>
        ...
        <div style={{ display: 'flex', gap: 16, justifyContent: 'center', flexWrap: 'wrap' }}>
          <button
            ...
            onMouseEnter={(e) => {
              ...
              e.currentTarget.style.boxShadow = '0 16px 50px rgba(255,69,0,0.6)';
            }}
            onMouseLeave={(e) => {
              e.currentTarget.style.transform = '';
              e.currentTarget.style.boxShadow = '0 8px 40px rgba(255,69,0,0.45)';
            }}
          >
            Começar Grátis
          </button>
    ...
    <section id="recursos" style={{ padding: '100px 48px', background: '#0E1425' }}>
      <div style={{ maxWidth: 1100, margin: '0 auto' }}>
        <div style={{ textAlign: 'center', marginBottom: 72 }}>
          ...
          <p style={{ color: '#7A869A', fontSize: 16, marginTop: 16, fontWeight: 300 }}>
            Do iniciante ao atleta de elite, o PaceX tem o recurso certo pra cada fase.
          </p>
        </div>
...
function FeatureCard({ feature, delay }) {
  ...
  return (
    ...
    >
      ...
      <p style={{ color: '#7A869A', fontSize: 14, lineHeight: 1.7, fontWeight: 300 }}>
        {feature.desc}
      </p>
    </div>
  );
    ...
    >
      ...
      <div style={{ marginBottom: 28 }}>
        ...
        <div style={{ display: 'flex', alignItems: 'baseline', gap: 6 }}>
          ...
          {plan.sub !== 'Para quem está começando' && (
            <span style={{ color: '#7A869A', fontSize: 13 }}>{plan.sub}</span>
          )}
        </div>
        {plan.sub === 'Para quem está começando' && (
          <div style={{ color: '#7A869A', fontSize: 13, marginTop: 4 }}>{plan.sub}</div>
        )}
      </div>

      <div
        style={{ borderTop: '1px solid rgba(255,255,255,0.06)', paddingTop: 24, marginBottom: 32 }}
      >
          ...
          <div key={i} style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 12 }}>
            <div
              style={{
                ...
                height: 16,
                borderRadius: '50%',
                background: plan.highlight ? '#FF4500' : 'rgba(255,255,255,0.1)',
                display: 'flex',
                alignItems: 'center',
                justifyContent: 'center',
                flexShrink: 0,
            ...
            >
              <svg width="8" height="8" viewBox="0 0 10 10">
                <path
                  ...
                  stroke={plan.highlight ? '#fff' : '#7A869A'}
                  strokeWidth="1.5"
                  fill="none"
                  strokeLinecap="round"
    ...
    >
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
        ...
        <div style={{ textAlign: 'right' }}>
          <div style={{ fontFamily: "'Space Mono', monospace", fontSize: 13, color: '#FF4500' }}>
            {t.pace}
          </div>
          <div style={{ fontFamily: "'Space Mono', monospace", fontSize: 10, color: '#7A869A' }}>
            pace médio
          </div>
        </div>
      </div>
    ...
    >
      ...
      <div
        style={{
          ...
          overflow: 'hidden',
          background:
            'radial-gradient(ellipse 80% 70% at 60% 90%, rgba(255,69,0,0.2) 0%, transparent 65%), linear-gradient(160deg, #0D1525 0%, #080C18 100%)',
        }}
      >
        <div
          style={{
        ...
        <div style={{ position: 'relative', zIndex: 2 }}>
          ...
          >
            ...
            VINDO
            <br />
            DE <span style={{ color: '#FF4500' }}>VOLTA</span>
          </h2>
          <p
            style={{
              color: '#7A869A',
          ...
          >
            {[
              ...
              <div key={l}>
                <div
                  style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: 28, color: '#F0F4FF' }}
                >
                  {n}
                </div>
                <div
        ...
        <div style={{ width: '100%', maxWidth: 400 }}>
          <div style={{ marginBottom: 40 }}>
            <div style={{ display: 'flex', alignItems: 'baseline', gap: 4, marginBottom: 8 }}>
              ...
              <span
                style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: 44, color: '#FF4500' }}
              >
                X
              </span>
            </div>
          ...
          <div style={{ textAlign: 'right', marginBottom: 28 }}>
            <a href="#" style={{ fontSize: 12, color: '#7A869A', textDecoration: 'none' }}>
              Esqueceu a senha?
            </a>
          </div>
          ...
          >
            {[
              ...
              },
              {
                label: 'Apple',
                icon: (
                  <svg width="16" height="16" viewBox="0 0 814 1000" fill="#F0F4FF">
                    <path d="M788.1 340.9c-5.8 4.5-108.2 62.2-108.2 190.5 0 148.4 130.3 200.9 134.2 202.2-.6 3.2-20.7 71.9-68.7 141.9-42.8 61.6-87.5 123.1-155.5 123.1s-85.5-39.5-164-39.5c-76 0-103.7 40.8-165.9 40.8s-105-57.8-155.5-127.4C46 376.6 56 282.1 56 282.1c0-151.3 99.5-230.9 197.1-230.9 54.3 0 99.5 35.5 133.2 35.5 32.2 0 82.9-37.8 147.2-37.8 18.7 0 108.2 1.9 164.6 78.7z" />
                  </svg>
                ),
              },
            ].map((btn) => (
          ...
          <p style={{ textAlign: 'center', color: '#7A869A', fontSize: 13 }}>
            Ainda não tem conta?{' '}
            <a href="#" style={{ color: '#FF4500', fontWeight: 600, textDecoration: 'none' }}>
              Crie grátis agora
            </a>
          </p>
        </div>
  ...
  return (
    ...
    >
      <div style={{ maxWidth: 1100, margin: '0 auto' }}>
        ...
        >
          <div>
            <div style={{ display: 'flex', alignItems: 'baseline', gap: 2, marginBottom: 12 }}>
              ...
              <span
                style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: 28, color: '#FF4500' }}
              >
                X
              </span>
            </div>
            ...
            >
              O app de corrida que evolui junto com você. Seu objetivo, seu ritmo, seu plano.
            </p>
          </div>
          {[
            ...
            <div key={col.title}>
              ...
              {col.links.map((l) => (
                <div key={l} style={{ marginBottom: 10 }}>
                  <a href="#" style={{ color: '#7A869A', fontSize: 13, textDecoration: 'none' }}>
                    {l}
                  </a>
                </div>
              ))}
        ...
        >
          <span style={{ color: '#7A869A', fontSize: 12 }}>
            © 2025 PaceX. Todos os direitos reservados.
          </span>
          <span
            style={{
              fontFamily: "'Space Mono', monospace",
