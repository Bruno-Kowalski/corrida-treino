  ...
  return (
    <nav
      style={{
        ...
        borderBottom:
          scrolled || isLogin ? '1px solid rgba(255,255,255,0.06)' : '1px solid transparent',
      ...
      {!isLogin && (
        ...
        >
          ...
          <img
            ...
            alt="X"
            style={{ height: 36, width: 'auto', marginLeft: -4 }}
          />
        </div>
      )}
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 36 }}>
          ...
          <button
            ...
            onMouseEnter={(e) => {
              ...
              e.currentTarget.style.boxShadow = '0 8px 32px rgba(255,69,0,0.55)';
            }}
            onMouseLeave={(e) => {
              e.currentTarget.style.transform = '';
              e.currentTarget.style.boxShadow = '0 4px 24px rgba(255,69,0,0.4)';
            }}
          >
            Entrar
          </button>
